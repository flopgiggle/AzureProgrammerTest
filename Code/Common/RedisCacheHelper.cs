...
namespace KidneyCareApi.Common
{
    ...
    {
        public static string RedisIp = "togo56@123.207.218.12:6379";//Util.GetConfigByName("RedisIp");
        ...
        public RedisCacheHelper()
        {
            ...
            var msgHeader1 = @"<msgHeader><?xml version=""1.0"" encoding=""utf-8"" ?><root><serverName>ValidToken</serverName><format>xml</format><callOperator>2068</callOperator><certificate>0x/P1AMtkFbQ/OwfFx9euR5MK+lXRff0</certificate></root></msgHeader>";

            var ss =
                @"<msgBody><?xml version=""1.0"" encoding=""utf-8"" ?><root><tokenCode>06125e83f165475ba87583d6cd32140e</tokenCode></root><msgBody>";
        }
