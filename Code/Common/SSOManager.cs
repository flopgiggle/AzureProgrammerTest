...
//    {
//        public static readonly int TokenLifeTime = 200;//int.Parse(ConfigurationManager<>.AppSettings["TokenLifeTime"]);
//        //验证码过期时间
//        private static readonly int AuthenKeyOutTime = 200;//int.Parse(ConfigurationManager.AppSettings["AuthenKeyOutTime"]);
       
//        public static readonly ICacheHelper cacheHelper = new RedisCacheHelper();
...
//                var token = tokenFromHeaders;
//                return token;
//            }
//            //if (Util.GetConfigByName("Debugger") == "true")
//            //{
//            //    return null;
//            //}
...
//            {
//                var headers = HttpContext.Current.Request.Headers;
//                if (headers["userId"].ToString() != null) {
...
//        //    SSOUserInfo userInfo = null;//Util.GetFromCallContext<SSOUserInfo>(ContextKey.UserInfo);
//        //    if (userInfo != null)
//        //    {
//        //        return userInfo;
//        //    }
//        //    //获取token
//        //    //var token = "mqkyEAXueUmv2uzBW/OF3w";//GetToken();
//        //    var token = GetToken();
