...
namespace Bingo.Common
{
    ...
    public class HttpHelper
    {
        ...
        private bool isOpenSession = false;
        private string userName = "";
        #endregion

        public HttpHelper(bool openSession,string userName) {
            isOpenSession = openSession;
            this.userName = userName;
        }

        public HttpHelper(bool openSession)
        {
            isOpenSession = openSession;
        }
        ...
        private void GetData(HttpItem item, HttpResult result)
        {
            ...
            #endregion
            if (isOpenSession && response.Headers["set-cookie"] != null)
            {
        ...
        private void SetPostData(HttpItem item)
        {
            ...
            if (!request.Method.Trim().ToLower().Contains("get"))
            {
                ...
                {
                    buffer = Encoding.UTF8.GetBytes(item.Postdata);
                }
                if (buffer != null)
                {
    ...
    public class HttpItem
    {
        ...
        public bool IsXRequestedWith { get; set; }
        #endregion
    }
    /// <summary>
    /// Http返回参数类
